...
PRIO_Scheduler::PRIO_Scheduler(int q, int m_prio) {
  this->quantum = q;
...
bool PRIO_Scheduler::q_isEmpty(vector<list<Process*>>* q) {
...
string PRIO_Scheduler::get_scheduler() { return "PRIO " + to_string(this->quantum); }

void PRIO_Scheduler::show_run_queue() {
  cout << "{ ";
